...
- [docs/phase1-smoke-test.md](docs/phase1-smoke-test.md)：Phase 1 冒烟测试
...
- [docs/phase2_3_7-runtime-tool-full-regression.md](docs/phase2_3_7-runtime-tool-full-regression.md)：runtime 全链路回归
...
- 不修改官方 AgentScope 源码。
- JSON permission/audit 文件不是生产级并发存储，只作为 MVP skeleton 和回归基础。
